...
def count_kmers(kmer_list):
    ...
    ## Step 2:
    ## begin your code
    #kmer_list= ['GTGACA','GTGACA','GTGACA', 'TGACAA', 'GACAAT', 'ACAATG', 'CAATGT', 'AATGTG', 'ATGTGC', 'TGTGCC', 'GTGCCC', 'TGCCCT', 'GCCCTG', 'CCCTGT', 'CCTGTT', 'CTGTTG', 'TGTTGT', 'GTTGTT']
    kmer_count_dict = {}
    ...
    #printing out sorted dict in tuples
...
def main():
    ...
    #sorting out a list of keys in order of counts
