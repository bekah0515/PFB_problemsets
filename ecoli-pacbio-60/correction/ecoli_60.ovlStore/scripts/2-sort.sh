...
#  This script should be executed from correction/ecoli_60.ovlStore.BUILDING/, but the binary needs
...
if [ -e ./ecoli_60.ovlStore.BUILDING/$jobname.info -a ! -e ./ecoli_60.ovlStore.BUILDING/$jobname.started ] ; then
  echo "Sorting job finished; info file './ecoli_60.ovlStore.BUILDING/$jobname.info' exists."
  exit
fi
#
#  Sort!
